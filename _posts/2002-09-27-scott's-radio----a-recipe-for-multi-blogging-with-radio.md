---
layout: post
title: Scott's Radio -- A Recipe for Multi Blogging with Radio
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<title>
			The FuzzyBlog! : Scott's Radio :: A Recipe for Multi Blogging with Radio
			</title>
...
Scott's Radio :: A Recipe for Multi Blogging with Radio

Welcome to Multi Blogging.&nbsp; In this recipe we're going to whip up a tasty treat called a "Multi Blog".&nbsp; A multi blog is a creamy good thing which lets you take one bit of content and publish it to N places where N is several different blogs.&nbsp; Here are the tools that you will need:

- 2 Cups of Patience
- 3 Liters of Caffeine
- A Copy of Radio UserLand from [UserLand Software](http://radio.userland.com/)
- This article from [Paolo](http://paolo.evectors.it/)
- Optional: A Copy of Essential Blogging (by Me !) from [O'Reilly](http://www.ora.com/)

Note: I don't mean to be cynical or disrespectful to Radio at all.&nbsp; I regard MultiBlogging as one of the single most useful features in Radio but it is tricky to setup and not for the faint of heart.&nbsp; Still the ability to take one piece of content and route it to multiple places while formatting it with different templates is an astounding feat and UserLand should be commended for this

| |

 This Page was last update: 9/27/2002; 7:09:14 AM  
